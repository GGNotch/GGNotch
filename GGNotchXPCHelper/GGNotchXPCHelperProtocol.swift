...
@objc protocol GGNotchXPCHelperLunarListener {
...
@objc protocol GGNotchXPCHelperProtocol {
...
/*
 To use the service from an application or other process, use NSXPCConnection to establish a connection to the service by doing something like this:
     ...
     connectionToService = NSXPCConnection(serviceName: "com.ggnotch.app.GGNotchXPCHelper")
     connectionToService.remoteObjectInterface = NSXPCInterface(with: (any GGNotchXPCHelperProtocol).self)
     connectionToService.resume()

 Once you have a connection to the service, you can use it like this:

     if let proxy = connectionToService.remoteObjectProxy as? GGNotchXPCHelperProtocol {
