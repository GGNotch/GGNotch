...
class GGNotchXPCHelper: NSObject, GGNotchXPCHelperProtocol {

    private weak var connection: NSXPCConnection?

    private let lunarStateQueue = DispatchQueue(label: "GGNotchXPCHelper.lunar.state")
    ...
    @objc func startLunarEventStream(with reply: @escaping (Bool) -> Void) {
        lunarStateQueue.async { [weak self] in
            ...
            } as? GGNotchXPCHelperLunarListener
