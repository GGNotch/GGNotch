        ...
        ZStack {
            ...
            case .cameraPermission:
                PermissionRequestView(
                    ...
                    description: "GGNotch includes a mirror feature that lets you quickly check your appearance using your camera, right from the notch. Camera access is required only to show this live preview. You can turn the mirror feature on or off at any time in the app.",
            ...
            case .calendarPermission:
                PermissionRequestView(
                    ...
                    description: "GGNotch can show all your upcoming events in one place. Access to your calendar is needed to display your schedule.",
                ...
                case .remindersPermission:
                    PermissionRequestView(
                        ...
                        description: "GGNotch can show your scheduled reminders alongside your calendar events. Access to Reminders is needed to display your reminders.",
            ...
            case .musicPermission:
                MusicControllerSelectionView(
                    onContinue: {
                        withAnimation(.easeInOut(duration: 0.6)) {
                            GGNotchViewCoordinator.shared.firstLaunch = false
                            step = .finished
                        }
                    }
                )
