...
extension Notification.Name {
    ...
    // MARK: - Sharing
    static let sharingDidFinish = Notification.Name("com.ggnotch.sharingDidFinish")
...
extension Defaults.Keys {
    ...
    static let releaseName = Key<String>("releaseName", default: "Black Island 🏝️")
    ...
    // MARK: Shelf
    static let ggNotchShelf = Key<Bool>("ggNotchShelf", default: true)
